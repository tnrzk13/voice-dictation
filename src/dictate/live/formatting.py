...
FORMATTING_COMMANDS: List[FormattingCommand] = sorted(
    [
        ...
        FormattingCommand("apostrophe s", "'s", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("full stop", ".", SpacingRule.REMOVE_BEFORE),
        # Brackets
        ...
        FormattingCommand("left parenthesis", "(", SpacingRule.REMOVE_AFTER),
        FormattingCommand("right parenthesis", ")", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("open bracket", "[", SpacingRule.REMOVE_AFTER),
        FormattingCommand("close bracket", "]", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("left bracket", "[", SpacingRule.REMOVE_AFTER),
        FormattingCommand("right bracket", "]", SpacingRule.REMOVE_BEFORE),
        ...
        FormattingCommand("begin quote", '"', SpacingRule.REMOVE_AFTER),
        FormattingCommand("end quote", '"', SpacingRule.REMOVE_BEFORE),
        ...
        FormattingCommand("begin single quote", "'", SpacingRule.REMOVE_AFTER),
        FormattingCommand("end single quote", "'", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("backtick", "`", SpacingRule.REMOVE_BOTH),
        # Path/infix symbols
        FormattingCommand("slash", "/", SpacingRule.REMOVE_BOTH),
        FormattingCommand("forward slash", "/", SpacingRule.REMOVE_BOTH),
        ...
        # Emoticons
        FormattingCommand("smiley face", ":-)", SpacingRule.DEFAULT),
        FormattingCommand("happy face", ":-)", SpacingRule.DEFAULT),
        FormattingCommand("frowny face", ":-(", SpacingRule.DEFAULT),
        FormattingCommand("sad face", ":-(", SpacingRule.DEFAULT),
        FormattingCommand("winky face", ";-)", SpacingRule.DEFAULT),
        FormattingCommand("wink face", ";-)", SpacingRule.DEFAULT),
        # Symbols - general
        FormattingCommand("en dash", " - ", SpacingRule.REMOVE_BOTH),
        FormattingCommand("em dash", "--", SpacingRule.REMOVE_BOTH),
        FormattingCommand("bullet point", "•", SpacingRule.DEFAULT),
        FormattingCommand("degree sign", "°", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("number sign", "#", SpacingRule.REMOVE_AFTER),
        FormattingCommand("hashtag", "#", SpacingRule.REMOVE_AFTER),
        FormattingCommand("pound sign", "£", SpacingRule.REMOVE_AFTER),
        FormattingCommand("euro sign", "€", SpacingRule.REMOVE_AFTER),
        FormattingCommand("cent sign", "¢", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("yen sign", "¥", SpacingRule.REMOVE_AFTER),
        FormattingCommand("copyright sign", "©", SpacingRule.DEFAULT),
        FormattingCommand("registered sign", "®", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("trademark sign", "™", SpacingRule.REMOVE_BEFORE),
        FormattingCommand("multiplication sign", "×", SpacingRule.DEFAULT),
        FormattingCommand("division sign", "÷", SpacingRule.DEFAULT),
        FormattingCommand("greater than sign", ">", SpacingRule.DEFAULT),
        FormattingCommand("less than sign", "<", SpacingRule.DEFAULT),
        # Symbols - programming
